...
public class Home {
    ...
    public void selectAccountMenu(WebDriver driver){
        waitUntilNextElementAppears(driver,By.xpath("//*[@href='javascript:void(0);']"), Duration.ofSeconds(10));
    ...
    public void selectCustomerMenu(WebDriver driver){
        waitUntilNextElementAppears(driver,By.linkText("Customers"),Duration.ofSeconds(3));
